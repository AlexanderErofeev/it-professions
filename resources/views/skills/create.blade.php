    ...
    <div class="container">
        ...
        <form action="{{ route('skills.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="short_description" id="short_description" class="form-control ckeditor @error('short_description') is-invalid @enderror @if (old('short_description')) is-valid @endif">{{ old('short_description') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control ckeditor @error('description') is-invalid @enderror @if (old('description')) is-valid @endif">{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
